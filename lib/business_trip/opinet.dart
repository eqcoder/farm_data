...
class Opinet extends StatefulWidget {
  const Opinet({super.key});
  @override
  State<Opinet> createState() => _OpinetState();
}
...
class _OpinetState extends State<Opinet> {
  ...
  final List<Uint8List?> _capturedMap = List.generate(3, (_) => null);
  final List<Uint8List?> _capturedOpinet = List.generate(3, (_) => null);
  DateTime? _selectedDate;
  int _selectedDuration = 0;
  List<String> farmNames = List.filled(3, '');
  String _mapUrl = 'https://map.naver.com/p/directions/-/-/-/car';
  final String _opinetUrl =
              ...
              _selectedDate != null
                  ...
                  : Center(
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 40,
                        color: const Color.fromARGB(255, 21, 110, 33),
                      ),
                    ),
                  ),
        ),
        ...
        return Column(
          children: [
            ...
            Text(
              DateFormat(
                'M월 d일',
              ).format(_selectedDate!.add(Duration(days: index))).toString(),
              style: const TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 30,
                color: Color.fromARGB(255, 17, 97, 70),
              ),
            ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 1,
                      child: _buildFarmSelection(),
                    ), // 기존 FarmSelection 위젯 재사용
                    Spacer(flex: 1),
                        ...
                        children: [
                          ElevatedButton.icon(
                            ...
                            onPressed: () async {
                              ...
                              if (screenshot != null) {
                                // 캡처 후 WebView final settings = provider.SettingsProvider();파괴
                                setState(
                                  () => _capturedMap[index] = screenshot,
                                );
          ...
          children: [
            ...
            Positioned(
              child: IconButton(
                ...
                icon: Icon(
                  Icons.camera_alt,
                  color: const Color.fromARGB(255, 9, 109, 39),
                ),
                onPressed: () {
                  _openCaptureDialog();
                }, // 사진 선택 함수 호출
                      ...
                      child: Row(
                        ...
                        children: [
                          ElevatedButton.icon(
                            ...
                            label: const Text('캡처'),
                            onPressed: () async {
                              screenshot = await _opinetController
                                  .takeScreenshot(
                                    screenshotConfiguration:
                                        ScreenshotConfiguration(
                                          rect: InAppWebViewRect(
                              ...
                              if (screenshot != null) {
                                // 캡처 후 WebView final settings = provider.SettingsProvider();파괴
                                setState(
                                  () => _capturedOpinet[index] = screenshot,
                                );
                                Navigator.pop(context, screenshot);
                              }
                            },
  ...
  Widget _buildFarmSelection() {
    return Row(
      ...
      children: [
        ElevatedButton(onPressed: () async {}, child: const Text('강원도 농업기술원')),
        Expanded(
